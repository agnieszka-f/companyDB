        ...
        describe('Reading data', () => {
          ...
          describe('Updating data', () => {
            ...
            it('should properly update multiple documents with "updateMany" method', async () => {
               await Department.updateMany({ $or: [ {name: 'Department #1'}, {name: 'Department #2'} ] },{ $set: {name: 'Department Updated'}});
               const updateDepartments = await Department.find({name: 'Department Updated'});
               const expectedLength = 2;
               expect(updateDepartments.length).to.be.equal(expectedLength);
            });
          ...
          describe('Removing data', () => {
            ...
            it('should properly remove one document with "remove" method', async () => {
                ...
                const findDep = await Department.findOne({name: 'Department #1'});
                expect(findDep).to.be.null;
            });
